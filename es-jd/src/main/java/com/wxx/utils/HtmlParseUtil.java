...
public class HtmlParseUtil {
    ...
    public static List<Books> parseJD(String keyword) throws Exception {
        ...
        // 使用 list 存放数据
        ArrayList<Books> goodsList = new ArrayList<>();
        ...
        for (Element el : elements) {
            ...
            goodsList.add(new Books(title, price, img));
        }
